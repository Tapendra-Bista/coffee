...
class Coffed4 extends StatefulWidget {
  const Coffed4({
    super.key,
  ...
  @override
  State<Coffed4> createState() => _Coffed4State();
}

class _Coffed4State extends State<Coffed4> {
                          ...
                          Row(
                            ...
                            children: [
                              TextButton(
                                  onPressed: () {
                                    setState(() {
                                      rate2 = double.parse(ratingcontrol4.text);
                                        Navigator.pop(context);
                                      ratingcontrol4.clear();
                                    });
                                  },
                                  child: Text(
                                    "Submit",
        ...
        child: Column(
          children: [
            Padding(
              ...
              child: Image(image: AssetImage(imgname4)),
            ),
            Padding(
              ...
              child: RichText(
                  text: TextSpan(
                      ...
                      children: [TextSpan(text: latte[1])])),
            )
          ],
        ),
      ),
